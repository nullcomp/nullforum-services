...
public class MainServer {
    ...
    public static void initializeModel(){
		...
		Answer answersA = new Answer(1, "Interface Gr�fica", competencies1);
		...
		Answer answersD = new Answer(4, "Interface Org�nica", competencies4);
		answers.add(answersD);
		
		model.addQuestion(new Question(2, "http://giulianobertoti.github.io/assets/img/user.png", "video", "Qual � este tipo de Intera��o Humano Computador", answers));
		...
		Answer answersA_2 = new Answer(1, "Aceler�metro", competencies5);
		...
		Answer answersB_2 = new Answer(2, "C�mera", competencies6);
		...
		model.addQuestion(new Question(1, "https://www.youtube.com/embed/JLQtIR_IFnQ", "video", "Qual sensor est� sendo usado para esta Intera��o Humano Computador", answers_2));
